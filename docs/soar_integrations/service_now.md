...
This document details the tools provided by the ServiceNow SOAR integration.

## Overview

ServiceNow is a cloud-based platform that provides service management software as a service. This integration allows Chronicle SOAR to interact with ServiceNow instances to manage incidents, records, users, and CMDB data as part of automated security workflows.
...
Wait for a field of a record to update to a desired value.
