...
def register_tools(mcp: FastMCP):
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    ...
                    "ScriptName": "AnyRun_Get Report", # Assuming same as actionName
    ...
    @mcp.tool()
    async def any_run_analyze_file(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], file_path: Annotated[str, Field(..., description="Specify full path to file to analyze.")], try_to_create_submission_for_x_times: Annotated[str, Field(..., description="How many attempts action should make to check if the API concurrency limit is not exceeded and try to create a new submission. Check is made every 2 seconds.")], wait_for_the_report: Annotated[Optional[bool], Field(default=None, description="Specify whether action should wait for the report creation. Report also can be obtained later with Get report action once scan is completed.")], os_version: Annotated[Optional[List[Any]], Field(default=None, description="OS version to run analysis on.")], operation_system_bitness: Annotated[Optional[List[Any]], Field(default=None, description="Bitness of Operation System")], os_environment_type: Annotated[Optional[List[Any]], Field(default=None, description="Environment type to run analysis on.")], network_connection_status: Annotated[Optional[List[Any]], Field(default=None, description="Network connection state for analysis.")], fake_net_feature_status: Annotated[Optional[List[Any]], Field(default=None, description="FakeNet feature state for analysis.")], use_tor: Annotated[Optional[List[Any]], Field(default=None, description="Use TOR or not while running analysis.")], opt_network_mitm: Annotated[Optional[List[Any]], Field(default=None, description="HTTPS MITM proxy option.")], opt_network_geo: Annotated[Optional[List[Any]], Field(default=None, description="Geo location option.")], opt_kernel_heavyevasion: Annotated[Optional[List[Any]], Field(default=None, description="Heavy evasion option.")], opt_privacy_type: Annotated[Optional[List[Any]], Field(default=None, description="Privacy settings for analysis.")], obj_ext_startfolder: Annotated[Optional[List[Any]], Field(default=None, description="Start location for analysis.")], opt_timeout: Annotated[Optional[str], Field(default=None, description="Timeout period for analysis in range from 10 to 9999 seconds.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AnyRun_AnalyzeFile", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def any_run_ping(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AnyRun_Ping", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def any_run_analyze_file_url(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], url_to_file: Annotated[str, Field(..., description="Specify URL to file to download and analyze.")], try_to_create_submission_for_x_times: Annotated[str, Field(..., description="How many attempts action should make to check if the API concurrency limit is not exceeded and try to create a new submission. Check is made every 2 seconds.")], wait_for_the_report: Annotated[Optional[bool], Field(default=None, description="Specify whether action should wait for the report creation. Report also can be obtained later with Get report action once scan is completed.")], os_version: Annotated[Optional[List[Any]], Field(default=None, description="OS version to run analysis on.")], operation_system_bitness: Annotated[Optional[List[Any]], Field(default=None, description="Bitness of Operation System")], os_environment_type: Annotated[Optional[List[Any]], Field(default=None, description="Environment type to run analysis on.")], network_connection_status: Annotated[Optional[List[Any]], Field(default=None, description="Network connection state for analysis.")], fake_net_feature_status: Annotated[Optional[List[Any]], Field(default=None, description="FakeNet feature state for analysis.")], use_tor: Annotated[Optional[List[Any]], Field(default=None, description="Use TOR or not while running analysis.")], opt_network_mitm: Annotated[Optional[List[Any]], Field(default=None, description="HTTPS MITM proxy option.")], opt_network_geo: Annotated[Optional[List[Any]], Field(default=None, description="Geo location option.")], opt_kernel_heavyevasion: Annotated[Optional[List[Any]], Field(default=None, description="Heavy evasion option.")], opt_privacy_type: Annotated[Optional[List[Any]], Field(default=None, description="Privacy settings for analysis.")], obj_ext_startfolder: Annotated[Optional[List[Any]], Field(default=None, description="Start location for analysis.")], opt_timeout: Annotated[Optional[str], Field(default=None, description="Timeout period for analysis in range from 10 to 9999 seconds.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AnyRun_AnalyzeFileURL", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def any_run_search_report_history(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], search_in_last_x_scans: Annotated[str, Field(..., description="Search for report in last x analyses executed in Any.Run.")], submission_name: Annotated[Optional[str], Field(default=None, description="Specific submission name to search for.")], skip_first_x_scans: Annotated[Optional[str], Field(default=None, description="Skip first x scans returned by Any.Run API.")], get_team_history: Annotated[Optional[bool], Field(default=None, description="Specify whether to get team history or not.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AnyRun_Search Report History", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def any_run_analyze_url(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], url_for_analysis: Annotated[str, Field(..., description="Specify URL to analyze. If URL is provided in both as entity and as this input parameter - action will be executed on input parameter.")], try_to_create_submission_for_x_times: Annotated[str, Field(..., description="How many attempts action should make to check if the API concurrency limit is not exceeded and try to create a new submission. Check is made every 2 seconds.")], wait_for_the_report: Annotated[Optional[bool], Field(default=None, description="Specify whether action should wait for the report creation. Report also can be obtained later with Get report action once scan is completed.")], os_version: Annotated[Optional[List[Any]], Field(default=None, description="OS version to run analysis on.")], operation_system_bitness: Annotated[Optional[List[Any]], Field(default=None, description="Bitness of Operation System")], os_environment_type: Annotated[Optional[List[Any]], Field(default=None, description="Environment type to run analysis on.")], network_connection_status: Annotated[Optional[List[Any]], Field(default=None, description="Network connection state for analysis.")], fake_net_feature_status: Annotated[Optional[List[Any]], Field(default=None, description="FakeNet feature state for analysis.")], use_tor: Annotated[Optional[List[Any]], Field(default=None, description="Use TOR or not while running analysis.")], opt_network_mitm: Annotated[Optional[List[Any]], Field(default=None, description="HTTPS MITM proxy option.")], opt_network_geo: Annotated[Optional[List[Any]], Field(default=None, description="Geo location option.")], opt_kernel_heavyevasion: Annotated[Optional[List[Any]], Field(default=None, description="Heavy evasion option.")], opt_privacy_type: Annotated[Optional[List[Any]], Field(default=None, description="Privacy settings for analysis.")], obj_ext_startfolder: Annotated[Optional[List[Any]], Field(default=None, description="Start location for analysis.")], opt_timeout: Annotated[Optional[str], Field(default=None, description="Timeout period for analysis in range from 10 to 9999 seconds.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AnyRun_AnalyzeURL", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
