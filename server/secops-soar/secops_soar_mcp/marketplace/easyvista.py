...
def register_tools(mcp: FastMCP):
    ...
    async def easy_vista_close_easy_vista_ticket(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], ticket_identifier: Annotated[str, Field(..., description="EasyVista ticket identifier, eg S201001_000001.")], comment: Annotated[Optional[str], Field(default=None, description="Comment explaining the closing of the ticket.")], actions_close_date: Annotated[Optional[str], Field(default=None, description="Closing date of open actions associated with the ticket and the anticipated closure action. Date should be in the following format: MM/DD/YYYY HH:MM:SS. If the wrong format is provided, action will use current datetime as close date.")], delete_ongoing_actions: Annotated[Optional[bool], Field(default=None, description="Specify whether to delete the ticket's ongoing actions on ticket closing.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        try:
            instance_response = await bindings.http_client.get(
                Endpoints.LIST_INTEGRATION_INSTANCES.format(INTEGRATION_NAME="EasyVista")
            )
            instances = instance_response.get("integration_instances", [])
        except Exception as e:
            # Log error appropriately in real code
            print(f"Error fetching instance for EasyVista: {e}")
        ...
        if instances:
            ...
            script_params = {}
            script_params["Ticket Identifier"] = ticket_identifier
            if comment is not None:
                script_params["Comment"] = comment
            if actions_close_date is not None:
                script_params["Actions Close Date"] = actions_close_date
            if delete_ongoing_actions is not None:
                script_params["Delete ongoing actions?"] = delete_ongoing_actions
            ...
            action_data = ApiManualActionDataModel(
                ...
                actionName="EasyVista_Close EasyVista Ticket",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "EasyVista_Close EasyVista Ticket", # Assuming same as actionName
            ...
            try:
                ...
                print(f"Error executing action EasyVista_Close EasyVista Ticket for EasyVista: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for EasyVista")
    ...
    async def easy_vista_add_comment_to_ticket(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], ticket_identifier: Annotated[str, Field(..., description="EasyVista ticket identifier to get info for, eg S201001_000001.")], comment: Annotated[str, Field(..., description="Comment to add to EasyVista ticket.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="EasyVista_Add Comment to Ticket",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "EasyVista_Add Comment to Ticket", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action EasyVista_Add Comment to Ticket for EasyVista: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for EasyVista")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    async def easy_vista_get_easy_vista_ticket(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], ticket_identifier: Annotated[str, Field(..., description="EasyVista ticket identifier to get info for, eg S201001_000001.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="EasyVista_Get EasyVista Ticket",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "EasyVista_Get EasyVista Ticket", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action EasyVista_Get EasyVista Ticket for EasyVista: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for EasyVista")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    async def easy_vista_ping(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="EasyVista_Ping",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "EasyVista_Ping", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action EasyVista_Ping for EasyVista: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for EasyVista")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    async def easy_vista_wait_for_the_ticket_update(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], ticket_identifier: Annotated[str, Field(..., description="EasyVista ticket identifier, eg S201001_000001.")], field_to_monitor: Annotated[Optional[List[Any]], Field(default=None, description="EasyVista ticket field to monitor for the update.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            script_params = {}
            script_params["Ticket Identifier"] = ticket_identifier
            if field_to_monitor is not None:
                script_params["Field To Monitor"] = field_to_monitor
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="EasyVista_Wait for the Ticket Update",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "EasyVista_Wait for the Ticket Update", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action EasyVista_Wait for the Ticket Update for EasyVista: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for EasyVista")
            return {"Status": "Failed", "Message": "No active instance found."}
