...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def sonic_wall_beta_list_address_groups(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], address_type: Annotated[List[str], Field(default=None, description="Specify which address type should be using for address groups.")], max_address_groups_to_return: Annotated[str, Field(default=None, description="Specify how many address groups to return.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
