...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def arc_sight_logger_send_query(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], query: Annotated[str, Field(..., description="Specify the query to send to ArcSight Logger event search.")], max_events_to_return: Annotated[Optional[str], Field(default=None, description="Specify the amount of events to return. Limit is 10000. This is ArcSight Logger limitation.")], time_frame: Annotated[Optional[str], Field(default=None, description="Specify the time frame which will be used to fetch events. \nPossible values:\n1m - 1 minute ago\n1h - 1 hour ago\n1d - 1 day ago\nNote: You can\u2019t combine different values, like 1d2h30m.")], fields_to_fetch: Annotated[Optional[str], Field(default=None, description="Specify what fields to fetch from ArcSight Logger. If nothing is specified, then all of the available fields will be returned.")], include_raw_event_data: Annotated[Optional[bool], Field(default=None, description="If enabled, raw event data is included in the response.")], local_search_only: Annotated[Optional[bool], Field(default=None, description="Indicates that ArcSight Logger event search is local only, and does not include ArcSight Logger peers. Set to false if you want to include peers in the event search.")], discover_fields: Annotated[Optional[bool], Field(default=None, description="Indicates that the ArcSight Logger search should try to discover fields in the events found.")], sort: Annotated[Optional[str], Field(default=None, description="Specify what sorting method to use.\nPossible values:\nascending\ndescending")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
