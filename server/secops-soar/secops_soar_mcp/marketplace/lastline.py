...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def lastline_search_analysis_history(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], search_in_last_x_scans: Annotated[str, Field(..., description="Search for report in last x analyses executed in Lastline.")], submission_name: Annotated[Optional[str], Field(default=None, description="Submission name to search for. Can be either URL or Filehash in a format of MD5 and SHA1.")], submission_type: Annotated[Optional[List[Any]], Field(default=None, description="Optionally specify a submission type to search for, either URL or FileHash.")], max_hours_backwards: Annotated[Optional[str], Field(default=None, description="Time frame for which to search for completed analysis tasks.")], skip_first_x_scans: Annotated[Optional[str], Field(default=None, description="Skip first x scans returned by Lastline API.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    ...
                    "ScriptName": "Lastline_Search Analysis History", # Assuming same as actionName
    ...
    async def lastline_get_analysis_results(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], threshold: Annotated[str, Field(..., description="Mark entity as suspicious if the score value for the entity is above the specified threshold.")], search_in_last_x_scans: Annotated[str, Field(..., description="Search for report for provided entity in last x analyses executed in Lastline.")], create_insight: Annotated[Optional[bool], Field(default=None, description="Specify whether to create insight based on the report data.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "Lastline_Get Analysis Results", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def lastline_submit_url(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], url_for_analysis: Annotated[str, Field(..., description="Specify URL to analyze.")], wait_for_the_report: Annotated[Optional[bool], Field(default=None, description="Specify whether the action should wait for the report creation. Report also can be obtained later with Get Analysis Results action once scan is completed.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def lastline_submit_file(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], file_path: Annotated[str, Field(..., description="Specify full path to file to analyze.")], wait_for_the_report: Annotated[Optional[bool], Field(default=None, description="Specify whether the action should wait for the report creation. Report also can be obtained later with Get Analysis Results action once scan is completed.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
