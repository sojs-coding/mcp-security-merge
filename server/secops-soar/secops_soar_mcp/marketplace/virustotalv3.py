...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def virus_total_v3_search_entity_graphs(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], sort_field: Annotated[List[str], Field(default=None, description="Specify what should be the sort field.")], max_graphs_to_return: Annotated[str, Field(default=None, description="Specify how many graphs to return.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
