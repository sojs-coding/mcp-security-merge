...
def register_tools(mcp: FastMCP):
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    ...
                    "ScriptName": "AWSEC2_Terminate Instance", # Assuming same as actionName
    ...
    @mcp.tool()
    async def awsec2_list_instances(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], instance_i_ds: Annotated[Optional[str], Field(default=None, description="One or more instance IDs. specify instance IDs, the output includes information for only the specified instances. Please note that the parameter \u2018Instance IDs\u2019 cannot be used with the parameter \u2018Max Results\u2019. \u2018Instance IDs\u2019 has priority over the \u2018Max Result\u2019 parameter.")], tag_filters: Annotated[Optional[str], Field(default=None, description="The key/value combination of a tag assigned to the resource. For example, to find all resources that have a tag with the key Owner and the value TeamA , specify Owner:TeamA. Comma separated tag filters. E.g. Name:Name1,Owner:TeamA. Returned instances will be fit to all filters.")], max_results: Annotated[Optional[str], Field(default=None, description="Specify how many instances to return. Default is 50. Maximum is 1000. Please note that the parameter \u2018Instance IDs\u2019 cannot be used with the parameter \u2018Max Results\u2019. \u2018Instance IDs\u2019 has priority over the \u2018Max Result\u2019 parameter.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_List Instances", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def awsec2_take_snapshot(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], instance_id: Annotated[str, Field(..., description="Instance ID. Specify the instance ID")], description: Annotated[Optional[str], Field(default=None, description="Specify the description of the snapshot")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_Take Snapshot", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def awsec2_revoke_security_group_egress(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], security_group_i_ds: Annotated[str, Field(..., description="One or more security group IDs. Separated by comma.")], ip_protocol: Annotated[Optional[List[Any]], Field(default=None, description="The IP protocol name. Use \"all\" to specify all protocols. Specifying \"all\" allows traffic on all ports, regardless of any port range you specify.")], from_port: Annotated[Optional[str], Field(default=None, description="The start of port range for the TCP and UDP protocols, or an ICMP type number.")], to_port: Annotated[Optional[str], Field(default=None, description="The end of port range for the TCP and UDP protocols allows traffic on all ports, regardless of any port range you specify.")], ip_ranges_cidr_ip: Annotated[Optional[str], Field(default=None, description="The IPv4 address in  CIDR format. To specify a single IPv4 address, use the /32 prefix length.")], i_pv6_ranges_cidr_ip: Annotated[Optional[str], Field(default=None, description="The IPv6 CIDR range.  To specify a single IPv6 address, use the /128 prefix length.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_Revoke Security Group Egress", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def awsec2_start_instance(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], instance_i_ds: Annotated[str, Field(..., description="One or more instance IDs. Separated by comma.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_Start Instance", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def awsec2_create_tags(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], resource_i_ds: Annotated[str, Field(..., description="One or more resource IDs. Separated by comma.")], tags: Annotated[str, Field(..., description="The key/value combination of a tag to be assigned to the resource. For example, to add to all specified resources a tag with the key Owner and the value TeamA , specify Owner:TeamA. You can specify multiple key/value combinations by comma separation. You can add or overwrite the specified tags. Please note: tag keys must be unique per resource.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_Create Tags", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def awsec2_ping(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_Ping", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def awsec2_list_security_groups(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], security_group_names: Annotated[Optional[str], Field(default=None, description="One or more security group Names [EC2-Classic and default VPC only]. Separated by comma. If you specify security group Names, the output includes information for only the specified names.")], security_group_i_ds: Annotated[Optional[str], Field(default=None, description="One or more security group IDs. Separated by comma. If you specify security group IDs, the output includes information for only the specified ids. Required for security groups in a non-default VPC.")], tag_filters: Annotated[Optional[str], Field(default=None, description="The key/value combination of a tag assigned to the security group. For example, to find all groups that have a tag with the key Owner and the value TeamA , specify Owner:TeamA. Comma separated tag filters. E.g. Name:Name1,Owner:TeamA. Returned groups will be fit to all filters.")], max_results: Annotated[Optional[str], Field(default=None, description="Specify how many security groups to return. Default is 50. Maximum is 1000. Please note that the parameters \u2018Security Group IDs\u2019 and \u2018Security Group Names\u2019 cannot be used with the parameter \u2018Max Results\u2019")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_List Security Groups", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def awsec2_authorize_security_group_egress(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], security_group_i_ds: Annotated[str, Field(..., description="One or more security group IDs. Separated by comma.")], ip_protocol: Annotated[Optional[List[Any]], Field(default=None, description="The IP protocol name. Use \u2019all\u2019 to specify all protocols. Specifying \u2018all\u2019 allows traffic on all ports, regardless of any port range you specify.")], from_port: Annotated[Optional[str], Field(default=None, description="The start of port range for the TCP and UDP protocols, or an ICMP type number.")], to_port: Annotated[Optional[str], Field(default=None, description="The end of port range for the TCP and UDP protocols allows traffic on all ports, regardless of any port range you specify.")], ip_ranges_cidr_ip: Annotated[Optional[str], Field(default=None, description="The IPv4 CIDR range. To specify a single IPv4 address, use the /32 prefix length.")], i_pv6_ranges_cidr_ip: Annotated[Optional[str], Field(default=None, description="The IPv6 CIDR range. To specify a single IPv6 address, use the /128 prefix length.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_Authorize Security Group Egress", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def awsec2_authorize_security_group_ingress(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], security_group_i_ds: Annotated[str, Field(..., description="One or more security group IDs. Separated by comma.")], ip_protocol: Annotated[Optional[List[Any]], Field(default=None, description="The IP protocol name. Use \"all\" to specify all protocols. Specifying \"all\" allows traffic on all ports, regardless of any port range you specify.")], from_port: Annotated[Optional[str], Field(default=None, description="The start of port range for the TCP and UDP protocols, or an ICMP type number.")], to_port: Annotated[Optional[str], Field(default=None, description="The end of port range for the TCP and UDP protocols allows traffic on all ports, regardless of any port range you specify.")], ip_ranges_cidr_ip: Annotated[Optional[str], Field(default=None, description="The IPv4 CIDR range. To specify a single IPv4 address, use the /32 prefix length.")], i_pv6_ranges_cidr_ip: Annotated[Optional[str], Field(default=None, description="The IPv6 CIDR range. To specify a single IPv6 address, use the /128 prefix length.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_Authorize Security Group Ingress", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def awsec2_revoke_security_group_ingress(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], security_group_i_ds: Annotated[str, Field(..., description="One or more security group IDs. Separated by comma.")], ip_protocol: Annotated[Optional[List[Any]], Field(default=None, description="The IP protocol name. Use \"all\" to specify all protocols. Specifying \"all\" allowes traffic on all ports, regardless of any port range you specify.")], from_port: Annotated[Optional[str], Field(default=None, description="The start of port range for the TCP and UDP protocols, or an ICMP type number.")], to_port: Annotated[Optional[str], Field(default=None, description="The end of port range for the TCP and UDP protocols allows traffic on all ports, regardless of any port range you specify.")], ip_ranges_cidr_ip: Annotated[Optional[str], Field(default=None, description="The IPv4 address in  CIDR format. To specify a single IPv4 address, use the /32 prefix length.")], i_pv6_ranges_cidr_ip: Annotated[Optional[str], Field(default=None, description="The IPv6 CIDR range.  To specify a single IPv6 address, use the /128 prefix length.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_Revoke Security Group Ingress", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def awsec2_stop_instance(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], instance_i_ds: Annotated[str, Field(..., description="One or more instance IDs. Separated by comma.")], force: Annotated[Optional[bool], Field(default=None, description="Forces the instances to stop. The instances do not have an opportunity to flush file system caches or file system metadata. If you use this option, you must perform file system check and repair procedures. This option is not recommended for Windows instances.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "AWSEC2_Stop Instance", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
