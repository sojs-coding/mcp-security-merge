...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def cloud_logging_execute_query(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], query: Annotated[str, Field(..., description="A query to find the logs for.")], project_id: Annotated[Optional[str], Field(default=None, description="The project ID to use in the integration. If you don't set a value for this parameter, the integration retrieves the project ID from your Google Cloud service account.")], organization_id: Annotated[Optional[str], Field(default=None, description="The organization ID to use in the integration.If you don't set a value for this parameter, the integration retrieves the project ID from your Google Cloud service account.")], time_frame: Annotated[Optional[List[Any]], Field(default=None, description="A period to retrieve the results from. If you select Custom, also configure the Start Time parameter.")], start_time: Annotated[Optional[str], Field(default=None, description="The start time to retrieve results. This parameter is required if you selected the Custom option for the Time Frame parameter. To configure this parameter, use the ISO 8601 format.")], end_time: Annotated[Optional[str], Field(default=None, description="The end time to retrieve results. If you don't set a value for this parameter and select the Custom option for the Time Frame parameter, the action uses the current time as the end time. To configure this parameter, use the ISO 8601 format.")], max_records_to_return: Annotated[Optional[str], Field(default=None, description="The maximum number of results to return. The default value is 50.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
