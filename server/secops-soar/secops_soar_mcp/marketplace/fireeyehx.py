...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def fire_eye_hx_get_host_alert_groups(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], acknowledgment_filter: Annotated[List[str], Field(default=None, description="Specify whether you want to return all of the alert groups or only acknowledged/unacknowledged.")], max_alert_groups_to_return: Annotated[str, Field(default=None, description="Specify how many Alert Groups to return per entity. Default: 20.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
