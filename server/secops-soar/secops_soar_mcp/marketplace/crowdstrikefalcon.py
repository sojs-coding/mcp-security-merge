...
def register_tools(mcp: FastMCP):
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    ...
                    "ScriptName": "CrowdStrikeFalcon_Add Comment to Detection", # Assuming same as actionName
    ...
    async def crowd_strike_falcon_submit_url(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], ur_ls: Annotated[str, Field(..., description="Specify the URLs that need to be submitted.")], sandbox_environment: Annotated[Optional[List[Any]], Field(default=None, description="Specify the sandbox environment for the analysis.")], network_environment: Annotated[Optional[List[Any]], Field(default=None, description="Specify the network environment for the analysis.")], check_duplicate: Annotated[Optional[bool], Field(default=None, description="If enabled, the action checks if the file was already submitted previously and returns an available report. Note: during the validation \u201cNetwork Environment\u201d and \u201cSandbox Environment\u201d are not taken into consideration.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Submit URL", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_update_incident(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], incident_id: Annotated[str, Field(..., description="Specify the ID of the incident that needs to be updated.")], customer_id: Annotated[Optional[str], Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], status: Annotated[Optional[List[Any]], Field(default=None, description="Specify the status for the incident.")], assign_to: Annotated[Optional[str], Field(default=None, description="Specify the name or email of the analyst to whom the incident needs to be assigned. If \"Unassign\" is provided, action will remove assignment from the incident. Note: for name you need to provide first and last name of the analyst in the following format \"{first name} {last name}\"")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Update Incident", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_run_script(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[Optional[str], Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], script_name: Annotated[Optional[str], Field(default=None, description="The name of the script file that needs to be executed. Note: either \u201cScript Name\u201d or \u201cRaw Script\u201d should be provided. If both \u201cScript Name\u201d and \u201cRaw Script\u201d are provided, then \u201cRaw Script\u201d will have the priority.")], raw_script: Annotated[Optional[str], Field(default=None, description="Raw powershell script payload that needs to be executed on the endpoints. Note: either \u201cScript Name\u201d or \u201cRaw Script\u201d should be provided. If both \u201cScript Name\u201d and \u201cRaw Script\u201d are provided, then \u201cRaw Script\u201d will have the priority.")], hostname: Annotated[Optional[str], Field(default=None, description="Comma-separated list of hostnames on which you want to execute the action. Note: action will run the action on both entities + this parameter values.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Run Script", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_execute_command(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], command: Annotated[str, Field(..., description="Specify what command to execute on the hosts.")], customer_id: Annotated[Optional[str], Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], admin_command: Annotated[Optional[bool], Field(default=None, description="If enabled, action will execute commands with the admin level permissions. This is necessary for certain commands like \"put\".")], hostname: Annotated[Optional[str], Field(default=None, description="Comma-separated list of hostnames on which you want to execute the action. Note: action will run the action on both entities + this parameter values.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Execute Command", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_close_detection(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], detection_id: Annotated[str, Field(..., description="Specify the id of the detection that needs to be closed.")], hide_detection: Annotated[Optional[bool], Field(default=None, description="If enabled, action will hide the detection in the UI.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Close Detection", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_add_incident_comment(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], incident_id: Annotated[str, Field(..., description="Specify the ID of the incident that needs to be updated.")], comment: Annotated[str, Field(..., description="Specify the comment for the incident.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Add Incident Comment", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_update_alert(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], alert_id: Annotated[str, Field(..., description="Specify the ID of the alert that needs to be updated.")], status: Annotated[Optional[List[Any]], Field(default=None, description="Specify the status for the alert.")], verdict: Annotated[Optional[List[Any]], Field(default=None, description="Specify the verdict for the alert.")], assign_to: Annotated[Optional[str], Field(default=None, description="Specify the name of the analyst to whom the alert needs to be assigned. If \"Unassign\" is provided, action will remove assignment from the alert. Note: API will accept any value that is provided, even if the underlying user doesn\u2019t exist.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Update Alert", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_list_hosts(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[Optional[str], Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], filter_logic: Annotated[Optional[List[Any]], Field(default=None, description="Specify what logic should be used, when searching for hosts.")], filter_value: Annotated[Optional[str], Field(default=None, description="Specify the value that should be used to filter hosts.")], max_hosts_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many hosts to return. Default: 50. Maximum: 1000.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_List Hosts", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_add_identity_protection_detection_comment(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], detection_id: Annotated[str, Field(..., description="Specify the ID of the detection that needs to be updated.")], comment: Annotated[str, Field(..., description="Specify the comment for the detection.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Add Identity Protection Detection Comment", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_get_hosts_by_ioc(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Get Hosts by IOC", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_ping(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Ping", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_contain_endpoint(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[Optional[str], Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], fail_if_timeout: Annotated[Optional[bool], Field(default=None, description="If enabled, action will be failed, if not all of the endpoints were contained.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Contain Endpoint", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_add_alert_comment(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], alert_id: Annotated[str, Field(..., description="Specify the ID of the alert that needs to be updated.")], comment: Annotated[str, Field(..., description="Specify the comment for the alert.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Add Alert Comment", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_update_ioc_information(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], description: Annotated[Optional[str], Field(default=None, description="Specify a new description for custom IOCs.")], source: Annotated[Optional[str], Field(default=None, description="Specify the source for custom IOCs.")], expiration_days: Annotated[Optional[str], Field(default=None, description="Specify the amount of days till expiration.")], detect_policy: Annotated[Optional[bool], Field(default=None, description="If enabled, IOCs that have been identifed, will send a notification. In other case, no action will be taken")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Update IOC Information", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_download_file(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], download_folder_path: Annotated[str, Field(..., description="Specify the path to the folder, where you want to store the threat file.")], overwrite: Annotated[bool, Field(..., description="If enabled, action will overwrite the file with the same name.")], customer_id: Annotated[Optional[str], Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Download File", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_get_event_offset(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], max_events_to_process: Annotated[str, Field(..., description="Specify how many events the action needs to process starting from the offset from 30 days ago.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Get Event Offset", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_upload_io_cs(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], platform: Annotated[str, Field(..., description="Specify a comma-separated list of the platforms related to the IOC. Possible values: Windows, Linux, Mac.")], severity: Annotated[List[Any], Field(..., description="Specify the severity for the IOC.")], comment: Annotated[Optional[str], Field(default=None, description="Specify a comment with more context related to IOC.")], host_group_name: Annotated[Optional[str], Field(default=None, description="Specify the name of the host group.")], action: Annotated[Optional[List[Any]], Field(default=None, description="Specify the action for the uploaded IOCs. Note: \"Block\" action can only be applied to hashes. Action will always apply \"Detect\" policy to all other IOC types.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Upload IOCs", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_get_host_information(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[Optional[str], Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], create_insight: Annotated[Optional[bool], Field(default=None, description="If enabled, action will create insights containing information regarding entities.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Get Host Information", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_on_demand_scan(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], file_paths_to_scan: Annotated[str, Field(..., description="Comma-separated list of paths to scan.")], customer_id: Annotated[Optional[str], Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], file_paths_to_exclude_from_scan: Annotated[Optional[str], Field(default=None, description="Comma-separated list of paths to exclude from scanning.")], host_group_name: Annotated[Optional[str], Field(default=None, description="Comma-separated list of host group names to initiate scanning for. Note: Separate scanning process is created for each host group.")], scan_description: Annotated[Optional[str], Field(default=None, description="Description for the scan. If no value is provided, the action sets the description to the following: \"Scan initialized by Chronicle SecOps.\"")], cpu_priority: Annotated[Optional[List[Any]], Field(default=None, description="The amount of CPU to  use for the underlying host during scanning.")], sensor_anti_malware_detection_level: Annotated[Optional[List[Any]], Field(default=None, description="Specify the sensor anti-malware detection level. Note: Detection level must be equal to or higher than the Prevention level.")], sensor_anti_malware_prevention_level: Annotated[Optional[List[Any]], Field(default=None, description="Specify the sensor anti-malware prevention level. Note: Detection level must be equal to or higher than the Prevention level.")], cloud_anti_malware_detection_level: Annotated[Optional[List[Any]], Field(default=None, description="Specify the cloud anti-malware detection level. Note: Detection level must be equal to or higher than the Prevention level.")], cloud_anti_malware_prevention_level: Annotated[Optional[List[Any]], Field(default=None, description="Specify the cloud anti-malware prevention level. Note: Detection level must be equal to or higher than the Prevention level.")], quarantine_hosts: Annotated[Optional[bool], Field(default=None, description="If enabled, underlying hosts are quarantined as part of scanning.")], create_endpoint_notification: Annotated[Optional[bool], Field(default=None, description="If enabled, the scanning process creates an endpoint notification.")], max_scan_duration: Annotated[Optional[str], Field(default=None, description="Number of hours for a scan to run. If no value is provided, the scan runs continuously.")], hostname: Annotated[Optional[str], Field(default=None, description="Comma-separated list of hostnames on which you want to execute the action. Note: action will run the action on both entities + this parameter values.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_On-Demand Scan", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_update_identity_protection_detection(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], detection_id: Annotated[str, Field(..., description="Specify the ID of the detection that needs to be updated.")], status: Annotated[Optional[List[Any]], Field(default=None, description="Specify the status for the detection.")], assign_to: Annotated[Optional[str], Field(default=None, description="Specify the name of the analyst to whom the detection needs to be assigned. If \"Unassign\" is provided, action will remove assignment from the detection. Note: API will accept any value that is provided, even if the underlying user doesn't exist.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Update Identity Protection Detection", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_get_process_name_by_ioc(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], devices_names: Annotated[str, Field(..., description="Specify a comma-separated list of devices for which you want to retrieve processes related to entities.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Get Process Name By IOC", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_delete_ioc(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Delete IOC", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_list_uploaded_io_cs(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], ioc_type_filter: Annotated[Optional[str], Field(default=None, description="Specify a comma-separated list of IOC types that should be returned. If nothing is provided, action will return IOCs from all types. Possible values: ipv4,ipv6,md5,sha256,domain.")], value_filter_logic: Annotated[Optional[List[Any]], Field(default=None, description="Specify the value filter logic. If \"Equal\" is selected, action will try to find the exact match among IOCs and if \"Contains\" is selected, action will try to find IOCs that contain that substring.")], value_filter_string: Annotated[Optional[str], Field(default=None, description="Specify the string that should be searched among IOCs.")], max_io_cs_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many IOCs to return. Default: 50. Maximum: 500.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_List Uploaded IOCs", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_submit_file(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], file_paths: Annotated[str, Field(..., description="Specify the file paths to the files that need to be submitted. Refer to the documentation portal for a list of the supported file formats.")], sandbox_environment: Annotated[Optional[List[Any]], Field(default=None, description="Specify the sandbox environment for the analysis.")], network_environment: Annotated[Optional[List[Any]], Field(default=None, description="Specify the network environment for the analysis.")], archive_password: Annotated[Optional[str], Field(default=None, description="Specify the password that would need to be used, when working with archive files.")], document_password: Annotated[Optional[str], Field(default=None, description="Specify the password that would need to be used, when working with Adobe or Office files. Maximum: 32 characters.")], check_duplicate: Annotated[Optional[bool], Field(default=None, description="If enabled, the action checks if the file was already submitted previously and returns the available report. Note: during the validation \u201cNetwork Environment\u201d and \u201cSandbox Environment\u201d are not taken into consideration.")], comment: Annotated[Optional[str], Field(default=None, description="Specify the comment for the submission.")], confidential_submission: Annotated[Optional[bool], Field(default=None, description="If enabled, the file is only shown to users within your customer account.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Submit File", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def crowd_strike_falcon_update_detection(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], detection_id: Annotated[str, Field(..., description="Specify the ID of the detection that needs to be updated.")], status: Annotated[List[Any], Field(..., description="Specify the new status for the detection.")], assign_detection_to: Annotated[Optional[str], Field(default=None, description="Specify the email address of the Crowdstrike Falcon user, who needs to be assigned to this detection")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Update Detection", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_list_host_vulnerabilities(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[Optional[str], Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], severity_filter: Annotated[Optional[str], Field(default=None, description="Specify the comma-separated list of severities for vulnerabilities.If nothing is provided, action will ingest all related vulnerabilities. Possible values: Critical, High, Medium, Low, Unknown.")], create_insight: Annotated[Optional[bool], Field(default=None, description="If enabled, action will create an insight per entity containing statistical information about related vulnerabilities.")], max_vulnerabilities_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many vulnerabilities to return per host. If nothing is provided action will process all of the related vulnerabilities.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_List Host Vulnerabilities", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def crowd_strike_falcon_lift_contained_endpoint(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[Optional[str], Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], fail_if_timeout: Annotated[Optional[bool], Field(default=None, description="If enabled, action will be failed, if containment was not lifted on all endpoints.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CrowdStrikeFalcon_Lift Contained Endpoint", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
