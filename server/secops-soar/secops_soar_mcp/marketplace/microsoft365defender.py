...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def microsoft365_defender_update_incident(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], incident_id: Annotated[str, Field(..., description="Specify the id of the incident that needs to be updated.")], status: Annotated[List[str], Field(default=None, description="Specify what status to set for the incident.")], classification: Annotated[List[str], Field(default=None, description="Specify what classification to set for the incident..")], determination: Annotated[List[str], Field(default=None, description="Specify what determination to set for the incident. Note: determination can only be set, when classification is true positive.")], assign_to: Annotated[str, Field(default=None, description="Specify to whom to assign this incident.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
