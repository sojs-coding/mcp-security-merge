...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def cb_cloud_list_reputation_overrides(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], reputation_override_list: Annotated[List[Any], Field(default=None, description="Specify override list action should return.")], reputation_override_type: Annotated[List[Any], Field(default=None, description="Specify override type action should return.")], start_from_row: Annotated[str, Field(default=None, description="Specify from which row action should fetch data.")], max_rows_to_return: Annotated[str, Field(default=None, description="Specify how many rows action should return.")], rows_sort_order: Annotated[List[Any], Field(default=None, description="Specify sort order for the returned rows. Rows are sorted based on \"create_time\" value.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def cb_cloud_create_a_reputation_override_for_sha_256_hash(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], filename: Annotated[str, Field(..., description="Specify a corresponding file name to add to reputation override.")], reputation_override_list: Annotated[List[Any], Field(..., description="Specify override list to create.")], sha_256_hash: Annotated[str, Field(default=None, description="Specify a SHA-256 hash value to create override for.")], description: Annotated[str, Field(default=None, description="Specify a description for the created reputation override.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
