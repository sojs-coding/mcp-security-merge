...
def register_tools(mcp: FastMCP):
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    ...
                    "ScriptName": "SiemplifyThreatFuse_Get Related IPs", # Assuming same as actionName
    ...
    async def siemplify_threat_fuse_get_related_domains(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], confidence_threshold: Annotated[str, Field(..., description="Specify what should be the confidence threshold. Note: Maximum is 100.")], search_threat_bulletins: Annotated[bool, Field(..., description="If enabled, action will search among threat bulletins.")], search_actors: Annotated[bool, Field(..., description="If enabled, action will search among actors.")], search_attack_patterns: Annotated[bool, Field(..., description="If enabled, action will search among attack patterns.")], search_campaigns: Annotated[bool, Field(..., description="If enabled, action will search among campaigns.")], search_courses_of_action: Annotated[bool, Field(..., description="If enabled, action will search among courses of action.")], search_identities: Annotated[bool, Field(..., description="If enabled, action will search among identities.")], search_incidents: Annotated[bool, Field(..., description="If enabled, action will search among incidents.")], search_infrastructures: Annotated[bool, Field(..., description="If enabled, action will search among infrastructures.")], search_intrusion_sets: Annotated[bool, Field(..., description="If enabled, action will search among intrusion sets.")], search_malware: Annotated[bool, Field(..., description="If enabled, action will search among malware.")], search_signatures: Annotated[bool, Field(..., description="If enabled, action will search among signatures.")], search_tools: Annotated[bool, Field(..., description="If enabled, action will search among tools.")], search_tt_ps: Annotated[bool, Field(..., description="If enabled, action will search among TTPs.")], search_vulnerabilities: Annotated[bool, Field(..., description="If enabled, action will search among vulnerabilities.")], max_domains_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many domains to return. Default: 50.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "SiemplifyThreatFuse_Get Related Domains", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def siemplify_threat_fuse_ping(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "SiemplifyThreatFuse_Ping", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def siemplify_threat_fuse_submit_observables(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], classification: Annotated[List[Any], Field(..., description="Specify the classification of the observable.")], threat_type: Annotated[List[Any], Field(..., description="Specify the threat type of the observables.")], source: Annotated[Optional[str], Field(default=None, description="Specify the intelligence source for the observable.")], expiration_date: Annotated[Optional[str], Field(default=None, description="Specify the expiration date in days for the observable. If nothing is specified here, action will create an observable that will never expire.")], trusted_circle_i_ds: Annotated[Optional[str], Field(default=None, description="Specify the comma-separated list of trusted circle ids. Observables will be shared with those trusted circles.")], tlp: Annotated[Optional[List[Any]], Field(default=None, description="Specify the TLP for your observables.")], confidence: Annotated[Optional[str], Field(default=None, description="Specify what should be the confidence for the observable. Note: this parameter will only work, if you create observables in your organization and requires 'Override System Confidence' to be enabled.")], override_system_confidence: Annotated[Optional[bool], Field(default=None, description="If enabled, created observables will have the confidence specified in the 'Confidence' parameter. Note: you can't share observables in trusted circles and publicly, when this parameter is enabled.")], anonymous_submission: Annotated[Optional[bool], Field(default=None, description="If enabled, action will make an anonymous submission.")], tags: Annotated[Optional[str], Field(default=None, description="Specify a comma-separated list of tags that you want to add to observable.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "SiemplifyThreatFuse_Submit Observables", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def siemplify_threat_fuse_get_related_associations(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], return_campaigns: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related campaigns and details about them.")], return_threat_bulletins: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related threat bulletins and details about them.")], return_actors: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related actors and details about them.")], return_attack_patterns: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related attack patterns and details about them.")], return_courses_of_action: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related courses of action and details about them.")], return_identities: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related identities and details about them.")], return_incidents: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related incidents and details about them.")], return_infrastructure: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related infrastructure and details about them.")], return_intrusion_sets: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related intrusion sets and details about them.")], return_malware: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related malware and details about them.")], return_signatures: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related signatures and details about them.")], return_tools: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related tools and details about them.")], return_tt_ps: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related TTPs and details about them.")], return_vulnerabilities: Annotated[Optional[bool], Field(default=None, description="If enabled, action will fetch related vulnerabilities and details about them.")], create_campaign_entity: Annotated[Optional[bool], Field(default=None, description="If enabled, action will create an entity out of available \u201cCampaign\u201d associations.")], create_actors_entity: Annotated[Optional[bool], Field(default=None, description="If enabled, action will create an entity out of available \u201cActor\u201d associations.")], create_signature_entity: Annotated[Optional[bool], Field(default=None, description="If enabled, action will create an entity out of available \u201cSignature\u201d associations.")], create_vulnerability_entity: Annotated[Optional[bool], Field(default=None, description="If enabled, action will create an entity out of available \u201cVulnerability\u201d associations.")], create_case_tag: Annotated[Optional[bool], Field(default=None, description="If enabled, action will create case tags based on the results.")], create_insight: Annotated[Optional[bool], Field(default=None, description="If enabled, action will create an insight base on the results.")], max_associations_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many associations to return per type. Default: 5")], max_statistics_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many top statistics results regarding IOCs to return. Note: action will at max process 1000 IOCs related to the association. If you provide \"0\", action will not try to fetch statistics information.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "SiemplifyThreatFuse_Get Related Associations", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def siemplify_threat_fuse_enrich_entities(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], severity_threshold: Annotated[List[Any], Field(..., description="Specify what should be the severity threshold for the entity, in order to mark it as suspicious. If multiple records are found for the same entity, action will take the highest severity out of all available records.")], confidence_threshold: Annotated[str, Field(..., description="Specify what should be the confidence threshold for the entity, in order to mark it as suspicious. Note: Maximum is 100. If multiple records are found for the entity, action will take the average. Active records have priority.")], ignore_false_positive_status: Annotated[Optional[bool], Field(default=None, description="If enabled, action will ignore the false positive status and mark the entity as suspicious based on the \"Severity Threshold\" and \"Confidence Threshold\". If disabled, action will never label false positive entities as suspicious, regardless, if they pass the \"Severity Threshold\" and \"Confidence Threshold\" conditions or not.")], add_threat_type_to_case: Annotated[Optional[bool], Field(default=None, description="If enabled, action will add threat types of the entity from all records as tags to the case. Example: apt")], create_insight: Annotated[Optional[bool], Field(default=None, description="If enabled, action will add an insight per processed entity.")], only_suspicious_entity_insight: Annotated[Optional[bool], Field(default=None, description="If enabled, action will create insight only for entities that exceeded the \"Severity Threshold\" and \"Confidence Threshold\".")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "SiemplifyThreatFuse_Enrich Entities", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def siemplify_threat_fuse_get_related_hashes(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], confidence_threshold: Annotated[str, Field(..., description="Specify what should be the confidence threshold. Note: Maximum is 100.")], search_threat_bulletins: Annotated[bool, Field(..., description="If enabled, action will search among threat bulletins.")], search_actors: Annotated[bool, Field(..., description="If enabled, action will search among actors.")], search_attack_patterns: Annotated[bool, Field(..., description="If enabled, action will search among attack patterns.")], search_campaigns: Annotated[bool, Field(..., description="If enabled, action will search among campaigns.")], search_courses_of_action: Annotated[bool, Field(..., description="If enabled, action will search among courses of action.")], search_identities: Annotated[bool, Field(..., description="If enabled, action will search among identities.")], search_incidents: Annotated[bool, Field(..., description="If enabled, action will search among incidents.")], search_infrastructures: Annotated[bool, Field(..., description="If enabled, action will search among infrastructures.")], search_intrusion_sets: Annotated[bool, Field(..., description="If enabled, action will search among intrusion sets.")], search_malware: Annotated[bool, Field(..., description="If enabled, action will search among malware.")], search_signatures: Annotated[bool, Field(..., description="If enabled, action will search among signatures.")], search_tools: Annotated[bool, Field(..., description="If enabled, action will search among tools.")], search_tt_ps: Annotated[bool, Field(..., description="If enabled, action will search among TTPs.")], search_vulnerabilities: Annotated[bool, Field(..., description="If enabled, action will search among vulnerabilities.")], max_hashes_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many hashes to return. Default: 50.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "SiemplifyThreatFuse_Get Related Hashes", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def siemplify_threat_fuse_get_related_email_addresses(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], confidence_threshold: Annotated[str, Field(..., description="Specify what should be the confidence threshold. Note: Maximum is 100.")], search_observables: Annotated[bool, Field(..., description="If enabled, action will search among observables.")], search_threat_bulletins: Annotated[bool, Field(..., description="If enabled, action will search among threat bulletins.")], search_actors: Annotated[bool, Field(..., description="If enabled, action will search among actors.")], search_attack_patterns: Annotated[bool, Field(..., description="If enabled, action will search among attack patterns.")], search_campaigns: Annotated[bool, Field(..., description="If enabled, action will search among campaigns.")], search_courses_of_action: Annotated[bool, Field(..., description="If enabled, action will search among courses of action.")], search_identities: Annotated[bool, Field(..., description="If enabled, action will search among identities.")], search_incidents: Annotated[bool, Field(..., description="If enabled, action will search among incidents.")], search_infrastructures: Annotated[bool, Field(..., description="If enabled, action will search among infrastructures.")], search_intrusion_sets: Annotated[bool, Field(..., description="If enabled, action will search among intrusion sets.")], search_malware: Annotated[bool, Field(..., description="If enabled, action will search among malware.")], search_signatures: Annotated[bool, Field(..., description="If enabled, action will search among signatures.")], search_tools: Annotated[bool, Field(..., description="If enabled, action will search among tools.")], search_tt_ps: Annotated[bool, Field(..., description="If enabled, action will search among TTPs.")], search_vulnerabilities: Annotated[bool, Field(..., description="If enabled, action will search among vulnerabilities.")], max_email_addresses_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many email addresses to return. Default: 50.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "SiemplifyThreatFuse_Get Related Email Addresses", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def siemplify_threat_fuse_get_related_ur_ls(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], confidence_threshold: Annotated[str, Field(..., description="Specify what should be the confidence threshold. Note: Maximum is 100.")], search_threat_bulletins: Annotated[bool, Field(..., description="If enabled, action will search among threat bulletins.")], search_actors: Annotated[bool, Field(..., description="If enabled, action will search among actors.")], search_attack_patterns: Annotated[bool, Field(..., description="If enabled, action will search among attack patterns.")], search_campaigns: Annotated[bool, Field(..., description="If enabled, action will search among campaigns.")], search_courses_of_action: Annotated[bool, Field(..., description="If enabled, action will search among courses of action.")], search_identities: Annotated[bool, Field(..., description="If enabled, action will search among identities.")], search_incidents: Annotated[bool, Field(..., description="If enabled, action will search among incidents.")], search_infrastructures: Annotated[bool, Field(..., description="If enabled, action will search among infrastructures.")], search_intrusion_sets: Annotated[bool, Field(..., description="If enabled, action will search among intrusion sets.")], search_malware: Annotated[bool, Field(..., description="If enabled, action will search among malware.")], search_signatures: Annotated[bool, Field(..., description="If enabled, action will search among signatures.")], search_tools: Annotated[bool, Field(..., description="If enabled, action will search among tools.")], search_tt_ps: Annotated[bool, Field(..., description="If enabled, action will search among TTPs.")], search_vulnerabilities: Annotated[bool, Field(..., description="If enabled, action will search among vulnerabilities.")], max_ur_ls_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many hashes to return. Default: 50.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "SiemplifyThreatFuse_Get Related URLs", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
