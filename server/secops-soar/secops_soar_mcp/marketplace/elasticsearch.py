...
def register_tools(mcp: FastMCP):
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    ...
                    "ScriptName": "ElasticSearch_Simple ES Search",
            ...
            try:
                ...
                print(f"Error executing action ElasticSearch_Simple ES Search for ElasticSearch: {e}")
    ...
    @mcp.tool()
    async def elastic_search_advanced_es_search(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], index: Annotated[Optional[str], Field(default=None, description="Search pattern for a elastic index.\r\nIn elastic, index is like a DatabaseName, and data is stored across various indexes.\r\nThis param defines in what index(es) to search. It can be an exact name ie: \"smp_playbooks-2019.06.13\"\r\nor you can use a (*) wildcard to search by a pattern. e: \"smp_playbooks-2019.06*\" or \"smp*\".\r\nTo learn more about elastic indexes visit https://www.elastic.co/blog/what-is-an-elasticsearch-index")], query: Annotated[Optional[str], Field(default=None, description="The search query to perform. It is in Lucene syntax.\r\nIE1: \"*\" (this is a wildcard that will return all record)\r\nIE1: \"level:error\"\r\nIE2: \"level:information\"\r\nIE3: \"level:error OR level:warning\"\r\nTo learn more about lucene syntax, visit\r\nhttps://www.elastic.co/guide/en/kibana/current/lucene-query.html#lucene-query\r\nhttps://www.elastic.co/guide/en/elasticsearch/reference/7.1/query-dsl-query-string-query.html#query-string-syntax")], limit: Annotated[Optional[str], Field(default=None, description="Limits the document return count, ie: 10.\r\n0 = No limit")], display_field: Annotated[Optional[str], Field(default=None, description="Limits the returned fields. Default \"*\" = Return all fields.\r\nYou can state a single field. ie: \"level\"")], search_field: Annotated[Optional[str], Field(default=None, description="Search field for free text queries (When query doesn't specify a field name).\r\nDefault is \"_all\", which means all fields are searched. It is best to use proper lucene syntanx on \"_all\" fields, or textual search on a specific field.\r\nie1: Search Field = \"_all\". Query = \"level:error\" Query will return all records where \"level\" field, equals \"error\".\r\nie2: Search Field = \"Message\", query = \"*Login Alarm*\". Query will return all records, which their \"Message\" field, contains the text \"Login Alarm\"")], timestamp_field: Annotated[Optional[str], Field(default=None, description="The name of the field to run time-based filtering against. Default is @timestamp. If both Earliest Date and Oldest Date are empty, no time-based filtering will occur.")], oldest_date: Annotated[Optional[str], Field(default=None, description="Start date of the search. Search will return only records equal or after this point in time.\r\nInput may be in exact UTC:\r\n\tFormat: YYYY-MM-DDTHH:MM:SSZ\r\n\tie: 2019-06-04T10:00:00Z\r\nInput may also be in relative form (using date-math):\r\n\tie: \"now\", \"now-1d\", \"now-1d/d\", \"now-2h/h\"\r\n\tto learn more about date-math visit https://www.elastic.co/guide/en/elasticsearch/reference/7.1/common-options.html#date-math")], earliest_date: Annotated[Optional[str], Field(default=None, description="End date of the search. Search will return only records equal or before this point in time.\r\nInput may be in exact UTC:\r\n\tFormat: YYYY-MM-DDTHH:MM:SSZ\r\n\tie: 2019-06-04T10:00:00Z\r\nInput may also be in relative form (using date-math):\r\n\tie: \"now\", \"now-1d\", \"now-1d/d\", \"now-2h/h\"\r\n\tto learn more about date-math visit https://www.elastic.co/guide/en/elasticsearch/reference/7.1/common-options.html#date-math")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "ElasticSearch_Advanced ES Search",
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                print(f"Error executing action ElasticSearch_Advanced ES Search for ElasticSearch: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for ElasticSearch")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    @mcp.tool()
    async def elastic_search_dsl_search(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], index: Annotated[Optional[str], Field(default=None, description="Search pattern for a elastic index.\r\nIn elastic, index is like a DatabaseName, and data is stored across various indexes.\r\nThis param defines in what index(es) to search. It can be an exact name ie: \"smp_playbooks-2019.06.13\"\r\nor you can use a (*) wildcard to search by a pattern. e: \"smp_playbooks-2019.06*\" or \"smp*\".\r\nTo learn more about elastic indexes visit https://www.elastic.co/blog/what-is-an-elasticsearch-index")], query: Annotated[Optional[str], Field(default=None, description="The DSL query to perform. The query must be a valid JSON, or *. For more information, please refer to https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl.html.")], limit: Annotated[Optional[str], Field(default=None, description="Limits the document return count, ie: 10.\r\n0 = No limit")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "ElasticSearch_DSL Search",
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
