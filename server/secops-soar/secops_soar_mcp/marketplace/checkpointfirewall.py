...
def register_tools(mcp: FastMCP):
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    ...
                    "ScriptName": "CheckPointFirewall_Run Script", # Assuming same as actionName
    ...
    async def check_point_firewall_add_url_to_group(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], ur_ls_group_name: Annotated[str, Field(..., description="Specify the name of the group to which you want to add URL.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CheckPointFirewall_Add Url To Group", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def check_point_firewall_download_log_attachment(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], log_i_ds: Annotated[str, Field(..., description="Specify the comma-separated list of log IDs from which you want to download attachments.")], download_folder_path: Annotated[str, Field(..., description="Specify the absolute path for the folder where the action should store the attachments.")], create_case_wall_attachment: Annotated[Optional[bool], Field(default=None, description="If enabled, action will create a case wall attachment for each successfully downloaded file. Note: that attachment will only be created if it\u2019s size is less than 3 MB.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CheckPointFirewall_Download Log Attachment", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def check_point_firewall_add_a_sam_rule(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], security_gateway_to_create_sam_rule_on: Annotated[str, Field(..., description="Specify the name of Security Gateway to create a rule for.")], action_for_the_matching_connections: Annotated[List[Any], Field(..., description="Specify the action that should be executed for the matching connections.")], how_to_track_matching_connections: Annotated[List[Any], Field(..., description="Specify how to track matching connections.")], source_ip: Annotated[Optional[str], Field(default=None, description="Specify the source IP to be added to the rule.")], source_netmask: Annotated[Optional[str], Field(default=None, description="Specify the source netmask to be added to the rule.")], destination_ip: Annotated[Optional[str], Field(default=None, description="Specify the destination IP to be added to the rule.")], destination_netmask: Annotated[Optional[str], Field(default=None, description="Specify the destination netmask to be added to the rule.")], port: Annotated[Optional[str], Field(default=None, description="Specify the port number to be added to the rule for example, 5005")], protocol: Annotated[Optional[str], Field(default=None, description="Specify the protocol name to be added to the rule for example, TCP")], expiration: Annotated[Optional[str], Field(default=None, description="Specify how long in seconds the newly added SAM rule should be active for example, 4. If nothing is specified - then the rule never expires.")], close_connections: Annotated[Optional[bool], Field(default=None, description="Specify if the existing matching connections should be closed.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CheckPointFirewall_Add a SAM Rule", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def check_point_firewall_add_ip_to_group(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], blacklist_group_name: Annotated[str, Field(..., description="Specify the name of the group to which you want to add IP address.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CheckPointFirewall_Add Ip To Group", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def check_point_firewall_list_policies_on_site(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], max_policies_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many policies to return in the response. Default: 50.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CheckPointFirewall_List Policies On Site", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def check_point_firewall_remove_sam_rule(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], security_gateway: Annotated[str, Field(..., description="Specify the name of Security Gateway from where to remove SAM Rule")], action_for_the_matching_connections: Annotated[List[Any], Field(..., description="Specify the action that should be executed for the matching connections.")], how_to_track_matching_connections: Annotated[List[Any], Field(..., description="Specify how to track matching connections.")], source_ip: Annotated[Optional[str], Field(default=None, description="Specify the source IP to be added to the rule.")], source_netmask: Annotated[Optional[str], Field(default=None, description="Specify the source netmask to be added to the rule.")], destination_ip: Annotated[Optional[str], Field(default=None, description="Specify the destination IP to be added to the rule.")], destination_netmask: Annotated[Optional[str], Field(default=None, description="Specify the destination netmask to be added to the rule.")], port: Annotated[Optional[str], Field(default=None, description="Specify the port number to be added to the rule for example, 5005")], protocol: Annotated[Optional[str], Field(default=None, description="Specify the protocol name to be added to the rule for example, TCP")], close_connections: Annotated[Optional[bool], Field(default=None, description="Specify if the existing matching connections should be closed.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CheckPointFirewall_Remove SAM Rule", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def check_point_firewall_show_logs(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], time_frame: Annotated[List[Any], Field(..., description="Specify what time frame should be used for log retrieval.")], log_type: Annotated[List[Any], Field(..., description="Specify what type of logs should be returned.")], query_filter: Annotated[Optional[str], Field(default=None, description="Specify the query filter that will be used to return logs.")], max_logs_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many logs to return. Maximum is 100. This is Checkpoint FireWall limitation.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CheckPointFirewall_Show Logs", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def check_point_firewall_remove_url_from_group(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], ur_ls_group_name: Annotated[str, Field(..., description="Specify the name of the group from which you want to remove URL.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CheckPointFirewall_Remove Url From Group", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    async def check_point_firewall_remove_ip_from_group(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], blacklist_group_name: Annotated[str, Field(..., description="Specify the name of the group from which you want to remove IP address.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CheckPointFirewall_Remove IP From Group", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
    ...
    @mcp.tool()
    async def check_point_firewall_list_layers_on_site(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], max_layers_to_return: Annotated[Optional[str], Field(default=None, description="Specify how many layers to return in the response. Default: 50.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "CheckPointFirewall_List Layers On Site", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
