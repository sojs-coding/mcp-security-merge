...
"""
    ...
    @mcp.tool()
    async def vectra_remove_tags(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], item_type: Annotated[List[str], Field(..., description="Select from which item type you want to remove tags.")], item_id: Annotated[str, Field(..., description="Specify ID of the detection/endpoint.")], tags: Annotated[str, Field(..., description="Specify what tags you want to remove from detection/endpoint. Tags should be separated by comma, e.g tag1, tag2.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        """
...
"""
    ...
    @mcp.tool()
    async def vectra_add_tags(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], item_type: Annotated[List[str], Field(..., description="Select to which item type you want to add tags.")], item_id: Annotated[str, Field(..., description="Specify ID of the detection/endpoint.")], tags: Annotated[str, Field(..., description="Specify what tags you want to add to detection/endpoint. Tags should be separated by comma, e.g tag1, tag2.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        """
