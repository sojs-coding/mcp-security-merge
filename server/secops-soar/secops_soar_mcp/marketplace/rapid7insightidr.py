...
def register_tools(mcp: FastMCP):
    ...
    async def rapid7_insight_idr_delete_saved_query(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], saved_query_id: Annotated[str, Field(..., description="ID of the saved query to delete in the format 00000000-0003-7218-0000-000000000000")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        try:
            instance_response = await bindings.http_client.get(
                Endpoints.LIST_INTEGRATION_INSTANCES.format(INTEGRATION_NAME="Rapid7InsightIDR")
            )
            instances = instance_response.get("integration_instances", [])
        except Exception as e:
            # Log error appropriately in real code
            print(f"Error fetching instance for Rapid7InsightIDR: {e}")
        ...
        if instances:
            ...
            script_params = {}
            script_params["Saved Query ID"] = saved_query_id
            ...
            action_data = ApiManualActionDataModel(
                ...
                actionName="Rapid7InsightIDR_Delete Saved Query",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "Rapid7InsightIDR_Delete Saved Query", # Assuming same as actionName
    ...
    async def rapid7_insight_idr_update_investigation(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], investigation_id: Annotated[str, Field(..., description="Specify the ID of the investigation that needs to be updated.")], status: Annotated[Optional[List[Any]], Field(default=None, description="Specify the status for the investigation.")], disposition: Annotated[Optional[List[Any]], Field(default=None, description="Specify the disposition for the investigation.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="Rapid7InsightIDR_Update Investigation",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "Rapid7InsightIDR_Update Investigation", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action Rapid7InsightIDR_Update Investigation for Rapid7InsightIDR: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for Rapid7InsightIDR")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    @mcp.tool()
    async def rapid7_insight_idr_list_investigations(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], time_frame: Annotated[Optional[str], Field(default=None, description="Specify a time frame in hours for which to fetch findings.")], record_limit: Annotated[Optional[str], Field(default=None, description="Specify how many records can be returned by the action.")], include_closed_investigations: Annotated[Optional[bool], Field(default=None, description="Specify whether to include closed investigations in results or not.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            if include_closed_investigations is not None:
                script_params["Include Closed Investigations?"] = include_closed_investigations
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="Rapid7InsightIDR_List Investigations",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "Rapid7InsightIDR_List Investigations", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action Rapid7InsightIDR_List Investigations for Rapid7InsightIDR: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for Rapid7InsightIDR")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    async def rapid7_insight_idr_ping(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="Rapid7InsightIDR_Ping",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "Rapid7InsightIDR_Ping", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action Rapid7InsightIDR_Ping for Rapid7InsightIDR: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for Rapid7InsightIDR")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    async def rapid7_insight_idr_set_investigation_status(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], investigation_id: Annotated[str, Field(..., description="ID of investigation to update status for. ID should be in the format like 8ec8e324-4522-4a6e-9838-81496a0cadb0")], status: Annotated[List[Any], Field(..., description="New Status of investigation.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="Rapid7InsightIDR_Set Investigation Status",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "Rapid7InsightIDR_Set Investigation Status", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action Rapid7InsightIDR_Set Investigation Status for Rapid7InsightIDR: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for Rapid7InsightIDR")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    async def rapid7_insight_idr_run_saved_query(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], saved_query_id: Annotated[str, Field(..., description="Because Saved query names are not unique, provide a saved query ID to execute.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="Rapid7InsightIDR_Run Saved Query",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "Rapid7InsightIDR_Run Saved Query", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action Rapid7InsightIDR_Run Saved Query for Rapid7InsightIDR: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for Rapid7InsightIDR")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    async def rapid7_insight_idr_list_saved_queries(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], record_limit: Annotated[Optional[str], Field(default=None, description="Specify how many records can be returned by the action.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="Rapid7InsightIDR_List Saved Queries",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "Rapid7InsightIDR_List Saved Queries", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action Rapid7InsightIDR_List Saved Queries for Rapid7InsightIDR: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for Rapid7InsightIDR")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    async def rapid7_insight_idr_set_investigation_assignee(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], investigation_id: Annotated[str, Field(..., description="ID of investigation to update assignee for. ID should be in the format like 8ec8e324-4522-4a6e-9838-81496a0cadb0.")], assignee_email: Annotated[str, Field(..., description="Email of a new assignee of investigation.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            script_params = {}
            script_params["Investigation ID"] = investigation_id
            script_params["Assignee email"] = assignee_email
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="Rapid7InsightIDR_Set Investigation Assignee",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "Rapid7InsightIDR_Set Investigation Assignee", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action Rapid7InsightIDR_Set Investigation Assignee for Rapid7InsightIDR: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for Rapid7InsightIDR")
            return {"Status": "Failed", "Message": "No active instance found."}
    ...
    @mcp.tool()
    async def rapid7_insight_idr_create_saved_query(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], name: Annotated[str, Field(..., description="Name for the new saved query")], statement: Annotated[str, Field(..., description="A statement to execute in query, should follow LEQL syntax, for example: where(foo=bar)")], time_frame: Annotated[str, Field(..., description="Specify a time frame in hours for which query should fetch data.")], logs: Annotated[Optional[str], Field(default=None, description="Log names query should execute against. Parameter accepts multiple values as a comma separated string.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if instances:
            ...
            script_params["Statement"] = statement
            script_params["Time Frame"] = time_frame
            if logs is not None:
                script_params["Logs"] = logs
            ...
            action_data = ApiManualActionDataModel(
                ...
                isPredefinedScope=is_predefined_scope, # Pass the is_predefined_scope parameter
                actionProvider="Scripts", # Assuming constant based on example
                actionName="Rapid7InsightIDR_Create Saved Query",
                properties={
                    "IntegrationInstance": instance_identifier,
                    "ScriptName": "Rapid7InsightIDR_Create Saved Query", # Assuming same as actionName
                    "ScriptParametersEntityFields": json.dumps(script_params)
                }
            )
            ...
            try:
                ...
                # Log error appropriately
                print(f"Error executing action Rapid7InsightIDR_Create Saved Query for Rapid7InsightIDR: {e}")
                return {"Status": "Failed", "Message": f"Error executing action: {e}"}
        else:
            print(f"Warning: No active integration instance found for Rapid7InsightIDR")
            return {"Status": "Failed", "Message": "No active instance found."}
